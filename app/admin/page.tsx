  ...
  return (
    <>
      ...
      <p className="mt-1.5 max-w-[62ch] text-[12.5px] leading-relaxed text-mut">
        Counts and timestamps only. Nothing on this page is derived from
        reading anyone&rsquo;s notes, tasks or saved links — the connection
        behind it has no permission to read them.
      </p>
      ...
      <div className="mt-5 grid gap-2.5 sm:grid-cols-2 lg:grid-cols-4">
        ...
        />
        <Metric label="Active · 7 days" value={String(o.activeSevenDays)} note="signed in at least once" />
      ...
      <section className="mt-4 rounded-xl border border-ln bg-surf p-4">
        ...
        <p className="mt-2 text-[12.5px]">
          ...
          <span className="text-mut"> account{o.failedSignins === 1 ? "" : "s"} currently locked out by the sign-in throttle.</span>
        </p>
      </section>
    </>
  );
